...
function Mover(m, _x, _y) {
    this.target = mainComp.layers.addSolid([0.5,0.5,0.5], "mover",30,30,1.0,totalTime);
    ...
    this.update = function() {
        ...
        this.aAcceleration = this.acceleration.x  * 3 ;
        this.aVelocity += this.aAcceleration;
        this.aVelocity = constrain(this.aVelocity, -2,2);
    ...
    this.display = function(i) {
        ...
        this.target.rotation.setValueAtTime(i / frameRate,this.angle);
    }; 
};
